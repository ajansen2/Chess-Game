...
public class UtilsForTests{
	 ...
	 */
	public static ArrayList<Coords> getDestCoords(ArrayList<Integer> givenMoves){
		ArrayList<Coords> coords=new ArrayList<>();
		for(int move: givenMoves){//put the destinations into a list
			coords.add(new Coords(Move.getEndIndex(move)));
		}
		return coords;
	}

	/**
	 * Generates a straight line of Coords starting at a given point, goes to edge of board regardless of what the line crosses
	 ...
	 */
	public static ArrayList<Coords> getLineOfCoords(Coords start,int x,int y){
